    ...
    <>
        ...
        <table>
          ...
          <tbody className="">
            ...
            {skillsimage?.data.map((item, key) => (
              <tr key={key}>
                <td>{item.skillsimage_aid}</td>
                <td>{item.skillsimage_image}</td>
                <td>{item.skillsimage_created}</td>
                <td className="table-action">
                  <ul>
                    {item.skillsimage_is_active ? (
                      <>
                        <li>
                          <button
      ...
      {store.isActive && (
        <ModalConfirmed
          position="center"
          queryKey="queryKey"
          endpoint={`/v1/skillsimage/active/${id}`}
...
export default SkillsImageTable;
