...
const Footer = () => {
  return (
    <>
      <footer className="bg-cGreen  py-10">
        <div className="container">
          <div className="grid grid-cols-[1.2fr_1fr_1fr_1fr] gap-10 phone:grid-cols-1 tablet:grid-cols-[1.2fr_1fr_1fr]">
            <div className="footer-block-social relative content-[''] phone:after:hidden tablet:after:block after:h-full after:w-[1px] after:absolute after:bg-white after:top-0 after:right-[-20px]">
              <div className="mb-5">
