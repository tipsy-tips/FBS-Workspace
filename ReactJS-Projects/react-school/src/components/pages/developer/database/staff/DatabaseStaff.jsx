...
const DatabaseStaff = ({ showInfo, setShowInfo }) => {
    ...
    >
      <div className="relative p-10">
        <div className="text-center mb-8">
          <h3 className="text-stone-400">SC123400</h3>
          <img
            src="https://placeholder.com/80"
            alt=""
            className="size-[120px] mx-auto rounded-full mb-4"
          />
          <h3 className="mb-1">Staff June</h3>
          <small className="opacity-60">Staff</small>
